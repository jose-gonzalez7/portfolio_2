...
const jobs = [
  ...
  },
  {
    ...
    active: false,
    bullets: [
      'Desarrollo y mantenimiento de aplicaciones cloud de alta disponibilidad.',
      'Refactorización y resolución de incidencias en coordinación con el equipo de QA.',
      'Trabajo en equipo bajo metodología Agile/Scrum (sprints, dailies y entregas iterativas).',
    ],
