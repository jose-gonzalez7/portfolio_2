...
const BrandIcons: Record<string, React.ReactNode> = {
  ...
  "TypeScript": (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-3.5 h-3.5 text-[#3178C6]"><path d="M2 2h20v20H2V2zm16.11 15.65v-6.5h-1.63v-1.55h4.94v1.55h-1.63v6.5h-1.68zm-5.69 0c-2.18 0-3.32-1.07-3.32-2.88 0-1.74 1.12-2.88 3.23-2.88 1.16 0 2.05.34 2.58.74l-.65 1.48c-.46-.35-1.12-.66-1.92-.66-.99 0-1.48.51-1.48 1.25 0 .84.6 1.15 1.76 1.41 1.63.36 2.47.96 2.47 2.62 0 1.83-1.22 2.92-3.41 2.92-1.27 0-2.39-.42-2.95-.87l.71-1.45c.48.35 1.34.75 2.23.75 1.05 0 1.56-.5 1.56-1.28 0-.82-.54-1.16-1.81-1.45z"/></svg>
  ),
  "Node.js": (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-3.5 h-3.5 text-[#339933]"><path d="M12 2l9.6 5.3v10.7L12 23.3l-9.6-5.3V7.3L12 2zm1 14.8v-4.5l4-2.3V6.7l-4.5 2.6-4.5-2.6v3.3l4 2.3v4.5l-4-2.3v-4.5l-4 2.3v3.3l8.5 4.9 8.5-4.9v-3.3l-4-2.3z"/></svg>
  ),
  "AWS": (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-3.5 h-3.5 text-[#FF9900]"><path d="M18.1 14.1c-1.3 1.7-3.6 2.8-5.8 2.8-3.4 0-6-2.5-6-6.1 0-3.4 2.4-6.1 6.2-6.1 2.3 0 4.2 1.2 5.3 2.6l-1.3 1.1c-.8-1-2.2-1.9-4-1.9-2.6 0-4.3 1.9-4.3 4.3 0 2.6 1.9 4.3 4.2 4.3 1.5 0 3.2-.8 4.2-2.1l1.5 1.1z"/></svg>
  ),
  "Python": (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-3.5 h-3.5 text-[#3776AB]"><path d="M12 2c2.7 0 3 .2 4.1.8 1.1.6 1.8 1.7 1.8 4.2H12V8h6v2h-2c-3.1 0-4.2-1.1-4.2-4.2V2zm0 20c-2.7 0-3-.2-4.1-.8-1.1-.6-1.8-1.7-1.8-4.2h5.9v-1H6v-2h2c3.1 0 4.2 1.1 4.2 4.2v3.8z"/></svg>
  ),
  "Docker": (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-3.5 h-3.5 text-[#2496ED]"><path d="M13.8 9.3h2.5v2.5h-2.5zm-3.6 0h2.5v2.5h-2.5zm-3.6 0h2.5v2.5H6.6zm-3.6 2.5h2.5v2.5H3zm13.3 1.3c2.4 0 4.4 1.1 5.3 2.8H2.1c.5-3.3 3.6-6 7.3-6.4V9.3h2.5v.3h.7c.4 0 .9.1 1.2.2z"/></svg>
  ),
  "PostgreSQL": (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-3.5 h-3.5 text-[#4169E1]"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z"/><path d="M12 6c-3.31 0-6 2.69-6 6s2.69 6 6 6 6-2.69 6-6-2.69-6-6-6zm0 10c-2.21 0-4-1.79-4-4s1.79-4 4-4 4 1.79 4 4-1.79 4-4 4z"/></svg>
  ),
  "OpenAI": (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-3.5 h-3.5 text-white"><path d="M20.9 9.9c.2-.9.2-1.9-.1-2.9-.4-1.2-1.3-2.2-2.4-2.8-1.1-.6-2.4-.6-3.6 0l-1.3-.8c.7-1.1.9-2.4.5-3.6-.4-1.2-1.3-2.2-2.4-2.8-1.1-.6-2.4-.6-3.6 0-1.2.6-2 1.7-2.3 3-.3 1.3 0 2.6.9 3.6l-.7 1.3c-1.3-.2-2.6.2-3.6.9-1.2.8-1.9 2.1-1.9 3.5 0 1.4.7 2.7 1.9 3.5 1 .7 2.3 1 3.6.9l.7 1.3c-.9 1-1.2 2.3-.9 3.6.3 1.3 1.1 2.4 2.3 3 1.2.6 2.5.6 3.6 0 1.1-.6 1.9-1.7 2.3-3 .3-1.3 0-2.6-.9-3.6l1.3.8c-.3 1.3 0 2.6.9 3.6.8 1 2.1 1.5 3.4 1.5.5 0 1-.1 1.5-.3 1.3-.7 2.2-1.9 2.4-3.3.2-1.4-.2-2.7-1-3.7l.8-1.3c1.3.2 2.6-.2 3.6-.9 1.2-.8 1.9-2.1 1.9-3.5 0-1.4-.7-2.7-1.9-3.5zM12 16.5c-2.5 0-4.5-2-4.5-4.5s2-4.5 4.5-4.5 4.5 2 4.5 4.5-2 4.5-4.5 4.5z"/></svg>
  )
};
          ...
          {experienceData.map((item, index) => (
            <div key={index} className={`relative flex flex-col md:flex-row gap-8 mb-24 ${index % 2 === 0 ? "md:flex-row-reverse" : ""}`}>
                  ...
                  <div className="p-6 md:p-8 relative z-10 h-full flex flex-col">
                      ...
                      <div className="flex flex-col pr-2">
                        ...
                        <div className={`text-sm font-medium flex items-center gap-2 text-${item.color}-400 mt-1`}>
                          ...
                          <a 
                            ...
                            className="hover:underline hover:text-white transition-colors flex items-center gap-1 group/link"
                          >
                            {item.company}
                    ...
                    <div className="flex flex-wrap gap-2 pt-4 border-t border-white/5">
                      {item.tags.map(tag => {
                        ...
                        if (BrandIcons[tag]) {
                          iconNode = BrandIcons[tag];
                        } else if (tag === "IA") {
                          iconNode = BrandIcons["OpenAI"];
                        } else if (tag === "Cloud") {
                          iconNode = <Cloud size={14} className="text-sky-400" />;
                        } else if (tag === "Scrum") {
                          iconNode = <Activity size={14} className="text-orange-400" />;
                        } else if (tag === "Prisma") {
                           iconNode = <Database size={14} className="text-white" />;
                        } else if (tag === "Git") {
                           iconNode = <Terminal size={14} className="text-red-400" />;
                        } else {
                          iconNode = <Globe size={14} className="opacity-70" />;
                        }
              ...
              <div className="absolute left-0 md:left-1/2 md:-translate-x-1/2 w-10 h-10 flex items-center justify-center z-20">
                <div className={`relative w-4 h-4 rounded-full bg-[#0b1220] border-2 ${item.active ? "border-cyan-400" : "border-slate-600"}`}>
                  {item.active && (
                    <>
              ...
              {/* FECHA */}
              <div className={`md:w-1/2 flex items-center ${index % 2 === 0 ? "md:justify-end" : "md:justify-start"} ml-12 md:ml-0 md:px-12`}>
                <div className={`inline-flex items-center gap-2 px-4 py-2 rounded-xl border text-sm font-mono font-semibold backdrop-blur-sm transition-all duration-300 ${item.active ? "bg-cyan-950/30 border-cyan-500/30 text-cyan-400 shadow-[0_0_15px_rgba(34,211,238,0.1)]" : "bg-slate-900/50 border-slate-800 text-slate-400"}`}>
                  <Calendar size={14} />
                  {item.period}
